...
const ExperienceTimeline = dynamic(
  () =>
    import("./components/experience-timeline").then(
      ...
      <main className="relative mx-auto max-w-7xl px-4">
        ...
        <section className="relative isolate grid grid-cols-1 items-center gap-10 py-16 md:grid-cols-2 md:py-24">
          <div className="relative z-10">
            ...
            <div className="mt-6 flex flex-row items-center gap-[3px] overflow-x-auto">
              <Button variant="outline"
                className="shrink-0 border-cyan-400/40 bg-white/5 text-cyan-100 hover:bg-white/10 mr-auto">
                <a
              ...
              <a
                aria-label="GitHub"
                href={portfolio.social.github || "https://github.com/Anuj-K15"}
                className="shrink-0 rounded-md border border-white/10 bg-white/5 p-2 text-slate-200/90 transition hover:border-cyan-300/40 hover:bg-cyan-500/10 hover:text-white"
              >
              ...
              <a
                ...
                href={
                  ...
                  "https://www.linkedin.com/in/anuj-karambalkar/"
                }
                className="shrink-0 rounded-md border border-white/10 bg-white/5 p-2 text-slate-200/90 transition hover:border-cyan-300/40 hover:bg-cyan-500/10 hover:text-white"
              >
                <Linkedin className="size-5" />
              </a>
              <Button className="shrink-0 rounded-md border border-white/10 bg-white/5 p-2 text-slate-200/90 transition hover:border-cyan-300/40 hover:bg-cyan-500/10 hover:text-white">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6 backdrop-blur-lg md:col-span-2">
                <p className="text-slate-300/85">
                  ...
                  layers, type‑safe data models and AI‑assisted workflows. I
                  value clean abstractions, accessibility and fast feedback
                  loops. Outside coding I explore GenAI tooling, cloud infra and
                  mentor peers in student tech communities.
                </p>
